...
--
myLayoutConfig x = spacingRaw False (Border 5 5 5 5) True (Border 5 5 5 5) True (avoidStruts (x))
myLayout = ((myLayoutConfig (tiled)) ||| (myLayoutConfig (Grid)) ||| (myLayoutConfig (Mirror tiled)) ||| Full)
  where
